...
def news_hunter_agent(state: AgentState):
    ...
    """
    print(f"🕵️‍♂️ NEWS HUNTER: Searching for {state['ticker']}...")
...
def analyst_swarm_agent(state: AgentState):
    ...
    """
    print("🧠 ANALYST SWARM: Analyzing sentiment...")
    prompt = f"""
...
def portfolio_manager_agent(state: AgentState):
    ...
    """
    print("⚖️ MANAGER: Reviewing opinions...")
    prompt = f"""
...
def execution_agent(state: AgentState):
    ...
    if decision in ["BUY", "SELL"]:
        print(f"💸 TRADER: Executing {decision}...")
